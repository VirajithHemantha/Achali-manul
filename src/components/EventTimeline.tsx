            ...
            >
              ...
              <div className="hidden md:flex w-1/2 px-12 justify-end group-even:justify-start">
                <motion.div
                  ...
                  className={`flex items-center gap-3 px-6 py-2 rounded-full border border-[#D4AF37]/20 bg-[#8B3355]/5 backdrop-blur-sm shadow-sm`}
                >
                  <Clock className="w-4 h-4 text-[#D4AF37]" />
                  <span className="font-serif text-[#8B3355] font-bold text-lg">{event.time}</span>
                </motion.div>
              </div>
              ...
              <div className="w-full md:w-1/2 pl-10 md:pl-0">
                ...
                >
                  ...
                  <div className="flex items-start gap-5">
                    <div className={`p-4 rounded-2xl bg-gradient-to-br from-[#8B3355] to-[#E87A90] text-white shadow-lg`}>
                    ...
                    <div className="flex-1">
                      ...
                      <h3 className="text-2xl font-serif text-[#8B3355] mb-3 group-hover:text-[#D4AF37] transition-colors">
                        {event.title}
                      </h3>
